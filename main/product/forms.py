...
class ProductForm(forms.ModelForm):
    ...
    class Meta:
        model = Product
        fields = ['title', 'product_code', 'categories', 'tags', 'main_image', 'main_image1', 'main_image2', 'main_image3', 'price', 'cost_price', 'brand', 'product_count', 'is_top', 'description']
        ...
        widgets = {
            ...
            "cost_price": forms.TextInput(attrs={"class": "form-control form-label",'placeholder': 'Mahsulot Sarflangan Narhi yozing'}),
